...
<table border="0" width="1140px" cellspacing="0" cellpadding="0"
   ...
   <td class="login_msg" width="400" align="center">
	 ...
	 <fieldset style="width: auto; margin: 0px auto;">
		...
		<form action="/CRM_Class1_war_exploded/user/login.action" name="frm"
			                       method="post" onsubmit="return verify()">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /><br />
          账&nbsp;号：<input id="usercode" type="text" name="user_code" />
          <br /><br />
          密&nbsp;码：<input id="password" type="password" name="user_password" />
          <br /><br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	function verify() {
		...
		var username = document.frm.user_code.value;
		var password = document.frm.user_password.value;
		if (username==""||password==""){
			document.getElementById("message").innerHTML="用户名密码不能为空";
			return false;
		}
		return true;
	}
