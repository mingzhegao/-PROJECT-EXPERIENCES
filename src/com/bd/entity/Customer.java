...
public class Customer {
    ...
    public Customer(Integer cust_id, String cust_name, String cust_user_id, String cust_create_id, String cust_source, String cust_industry, String cust_level, String cust_linkman, String cust_phone, String cust_mobile, String cust_zipcode, String cust_address, Date cust_createtime) {
        this.cust_id = cust_id;
        this.cust_name = cust_name;
        this.cust_user_id = cust_user_id;
        this.cust_create_id = cust_create_id;
